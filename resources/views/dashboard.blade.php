        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="flex-1 p-6">
                ...
                <div class="mb-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-xl font-semibold text-foreground">My Files</h2>
                ...
                <div class="bg-card rounded-lg border border-border shadow-sm">
                    ...
                    <div class="px-6 py-4 border-b border-border">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-lg font-semibold text-foreground">My Files</h3>
                                <p class="text-sm text-muted-foreground">Manage and organize your uploaded files</p>
                            </div>
                            <div class="flex items-center space-x-3">
                                <!-- Search -->
                                <div class="relative">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-border">
                            ...
                            <tbody class="bg-card divide-y divide-border">
                                @forelse(\App\Models\File::with('user')->latest()->get() as $file)
